...
public class GameRepository {
    ...
    public List<Game> getAllGames(){
        ...
        Game diceRoll = new Game("Dice Roll", R.drawable.dicegamelogo, R.drawable.gradient_colour_2, R.font.caveat_variablefont_wght);
        Game coinFlip = new Game("Coin Flip", R.drawable.coinlogo, R.drawable.gradient_colour_4, R.font.dancingscript_variablefont_wght);
        Game cardPick = new Game("Pick a Card", R.drawable.deckofcardslogo, R.drawable.gradient_colour_1, R.font.indieflower_regular);
        Game drawStraws = new Game("Draw Straws", R.drawable.strawslogo, R.drawable.gradient_colour_3, R.font.moondance_regular);
